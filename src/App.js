...
function App() {
  ...
  React.useEffect(() => {
    axios
      .get("https://629f604f461f8173e4e81486.mockapi.io/catalog")
      .then((res) => {
        setItems(res.data);
      });
    axios
      .get("https://629f604f461f8173e4e81486.mockapi.io/cart")
      .then((res) => {
        setCartItems(res.data);
      });
    axios
      .get("https://629f604f461f8173e4e81486.mockapi.io/favorites")
      .then((res) => {
  ...
  const onAddToCart = (obj) => {
    axios.post("https://629f604f461f8173e4e81486.mockapi.io/cart", obj);
    setCartItems((prev) => [...prev, obj]);
  };

  const onRemoveItem = (id) => {
    axios.delete(`https://629f604f461f8173e4e81486.mockapi.io/cart/${id}`);
